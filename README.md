...
$selfieType = "selfieType_example"; // string | 
$signature = "signature_example"; // string | 
$signatureType = "signatureType_example"; // string | 

try {
    $result = $apiInstance->uploadImagesPost($selfie, $selfieType, $signature, $signatureType);
    print_r($result);
} catch (Exception $e) {
