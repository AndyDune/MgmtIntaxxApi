...
*DefaultApi* | [**customerPincodeChangePost**](docs/Api/DefaultApi.md#customerpincodechangepost) | **POST** /customer/pincode-change | Request to change customer pincode.
...
*DefaultApi* | [**uploadOrderFilePost**](docs/Api/DefaultApi.md#uploadorderfilepost) | **POST** /upload-order-file | Upload order file
*DefaultApi* | [**valueVariantsPost**](docs/Api/DefaultApi.md#valuevariantspost) | **POST** /value-variants | Get available value variants
...
## Documentation For Models
 ...
 - [ValueVariantRequest](docs/Model/ValueVariantRequest.md)
