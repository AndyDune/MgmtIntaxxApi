...
'newsletter' => 'bool',
'rechtliches' => 'bool',
'productIsFinance' => 'bool',
'productIsIsnuranceAndPkv' => 'bool',
'productIsPreventionAndHealth' => 'bool',
'children' => 'int'    ];
...
'newsletter' => null,
'rechtliches' => null,
'productIsFinance' => null,
'productIsIsnuranceAndPkv' => null,
'productIsPreventionAndHealth' => null,
'children' => null    ];
...
'productIsFinance' => 'product_is_finance',
'productIsIsnuranceAndPkv' => 'product_is_isnurance_and_pkv',
'productIsPreventionAndHealth' => 'product_is_prevention_and_health',
'children' => 'children'    ];
...
'productIsFinance' => 'setProductIsFinance',
'productIsIsnuranceAndPkv' => 'setProductIsIsnuranceAndPkv',
'productIsPreventionAndHealth' => 'setProductIsPreventionAndHealth',
...
'productIsFinance' => 'getProductIsFinance',
'productIsIsnuranceAndPkv' => 'getProductIsIsnuranceAndPkv',
'productIsPreventionAndHealth' => 'getProductIsPreventionAndHealth',
'children' => 'getChildren'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['productIsFinance'] = isset($data['productIsFinance']) ? $data['productIsFinance'] : null;
        $this->container['productIsIsnuranceAndPkv'] = isset($data['productIsIsnuranceAndPkv']) ? $data['productIsIsnuranceAndPkv'] : null;
        $this->container['productIsPreventionAndHealth'] = isset($data['productIsPreventionAndHealth']) ? $data['productIsPreventionAndHealth'] : null;
    ...
    /**
     * Gets productIsFinance
     *
     * @return bool
     */
    public function getProductIsFinance()
    {
        return $this->container['productIsFinance'];
    }

    /**
     * Sets productIsFinance
     *
     * @param bool $productIsFinance productIsFinance
     *
     * @return $this
     */
    public function setProductIsFinance($productIsFinance)
    {
        $this->container['productIsFinance'] = $productIsFinance;

        return $this;
    }

    /**
     * Gets productIsIsnuranceAndPkv
     *
     * @return bool
     */
    public function getProductIsIsnuranceAndPkv()
    {
        return $this->container['productIsIsnuranceAndPkv'];
    }

    /**
     * Sets productIsIsnuranceAndPkv
     *
     * @param bool $productIsIsnuranceAndPkv productIsIsnuranceAndPkv
     *
     * @return $this
     */
    public function setProductIsIsnuranceAndPkv($productIsIsnuranceAndPkv)
    {
        $this->container['productIsIsnuranceAndPkv'] = $productIsIsnuranceAndPkv;

        return $this;
    }

    /**
     * Gets productIsPreventionAndHealth
     *
     * @return bool
     */
    public function getProductIsPreventionAndHealth()
    {
        return $this->container['productIsPreventionAndHealth'];
    }

    /**
     * Sets productIsPreventionAndHealth
     *
     * @param bool $productIsPreventionAndHealth productIsPreventionAndHealth
     *
     * @return $this
     */
    public function setProductIsPreventionAndHealth($productIsPreventionAndHealth)
    {
        $this->container['productIsPreventionAndHealth'] = $productIsPreventionAndHealth;
