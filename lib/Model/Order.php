...
class Order implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['workflowTemplateId'] = isset($data['workflowTemplateId']) ? $data['workflowTemplateId'] : null;
    }
    ...
    /**
     * Gets workflowTemplateId
     *
     * @return int
     */
    public function getWorkflowTemplateId()
    {
        return $this->container['workflowTemplateId'];
    }

    /**
     * Sets workflowTemplateId
     *
     * @param int $workflowTemplateId Workflow alfa template id to start work with.
     *
     * @return $this
     */
    public function setWorkflowTemplateId($workflowTemplateId)
    {
        $this->container['workflowTemplateId'] = $workflowTemplateId;
