...
class DefaultApi
{
     ...
     * @param  string $idCardFront idCardFront (required)
     * @param  string $idCardBack idCardBack (required)
     *
     * @throws \AndyDune\MgmtIntaxxApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AndyDune\MgmtIntaxxApi\Model\Response
     */
    public function updateKmcDataImagesPost($id, $idCardFront, $idCardBack)
    {
     ...
     * @param  string $idCardFront (required)
     * @param  string $idCardBack (required)
     *
     * @throws \AndyDune\MgmtIntaxxApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AndyDune\MgmtIntaxxApi\Model\Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateKmcDataImagesPostWithHttpInfo($id, $idCardFront, $idCardBack)
    {
        $returnType = '\AndyDune\MgmtIntaxxApi\Model\Response';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateKmcDataImagesPostAsync($id, $idCardFront, $idCardBack)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateKmcDataImagesPostAsyncWithHttpInfo($id, $idCardFront, $idCardBack)
    {
        $returnType = '\AndyDune\MgmtIntaxxApi\Model\Response';
        $request = $this->updateKmcDataImagesPostRequest($id, $idCardFront, $idCardBack);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateKmcDataImagesPostRequest($id, $idCardFront, $idCardBack)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateKmcDataImagesPost'
            );
        }
        // verify the required parameter 'idCardFront' is set
        if ($idCardFront === null || (is_array($idCardFront) && count($idCardFront) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $idCardFront when calling updateKmcDataImagesPost'
            );
        }
        // verify the required parameter 'idCardBack' is set
        if ($idCardBack === null || (is_array($idCardBack) && count($idCardBack) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $idCardBack when calling updateKmcDataImagesPost'
            );
        }
